...
<aside class="sidebar">
    <ul>
        ...
        <li><a class="nav-link <?= ($current_page == 'standardized_tests.php') ? 'active' : '' ?>" href="standardized_tests.php"><i class="fa-solid fa-pen-to-square"></i> <span>Test Tracker (GRE/GMAT)</span></a></li>
