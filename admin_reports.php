...
<div class="glass-card animate-gravity delay-1">
    <h2><i class="fa-solid fa-filter" style="color:var(--primary); margin-right:10px;"></i> Filter by Date Range</h2>
    <form method="get" class="grid grid-3" style="align-items:flex-end;">
        <div>
            <label><i class="fa-solid fa-calendar-days" style="margin-right:5px; color:var(--text-muted);"></i> Start Date</label>
            <input type="date" name="start_date" value="<?= htmlspecialchars($startObj->format('Y-m-d')) ?>">
        </div>
        <div>
            <label><i class="fa-solid fa-calendar-days" style="margin-right:5px; color:var(--text-muted);"></i> End Date</label>
            <input type="date" name="end_date" value="<?= htmlspecialchars($endObj->format('Y-m-d')) ?>">
        </div>
        <div>
            <button type="submit" class="btn-primary" style="margin-top:4px;"><i class="fa-solid fa-rotate" style="margin-right:8px;"></i> Apply Filter</button>
        </div>
    </form>
</div>
...
<div class="grid mt-3">
    <div class="glass-card animate-gravity delay-4">
        <h2><i class="fa-solid fa-chart-area" style="color:var(--primary); margin-right:10px;"></i> Student Registration Trends</h2>
